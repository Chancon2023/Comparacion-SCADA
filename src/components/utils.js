/* utils.js – Perfil minería + compatibilidad v3.7.1 (Charts/Home)
 * Exports:
 *  - analyzeText, scoreFeature, computeRanking
 *  - MINING_WEIGHTS, CRITICAL_KEYS
 *  - sum, groupBy, toCSV, downloadBlob, formatNumber
 *  - (legacy) prepareData, classForCell
 *  - (charts) COLORS, scoreValue
 */
...
// Algunas páginas importan estos utilitarios. Los definimos de forma segura.
