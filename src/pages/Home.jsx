...
import { classForCell, prepareData } from "../components/utils.js";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50">
          ...
          {activeTab && (
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="card p-4 grid grid-cols-2 gap-3">
                <div>
                  <h4 className="font-medium text-sm mb-1">Pros (auto)</h4>
                  <ul className="text-sm space-y-1">
                    {/* Autogenerados en páginas dedicadas con mejor algoritmo */}
                    <li className="badge pro">Abre el radar para ver pros/contras por plataforma</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-medium text-sm mb-1">Contras (auto)</h4>
                  <ul className="text-sm space-y-1">
                    <li className="badge con">Abre el radar para ver pros/contras por plataforma</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <footer className="max-w-7xl mx-auto px-4 pb-10 text-xs text-slate-500">Hecho con tus planillas.</footer>
    </div>
  );
}
